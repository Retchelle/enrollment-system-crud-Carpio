...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function populateStudentsTable() {
        ...
        try {
            const res = await fetch('http://localhost/my_midterm/api/Students/getStudents.php');
    ...
    async function renderStudentForm(editData) {
        ...
        try {
            programsRes = await fetch('http://localhost/my_midterm/api/Programs/getPrograms.php');
        ...
        document.getElementById('student-form').onsubmit = async e => {
            ...
            try {
                let url = 'http://localhost/my_midterm/api/Students/addStudent.php';
                let body = {stud_id, name, program_id, allowance};
                if (editData) {
                    url = 'http://localhost/my_midterm/api/Students/updateStudent.php';
    ...
    async function deleteStudent(id) {
        ...
        try {
            const res = await fetch('http://localhost/my_midterm/api/Students/deleteStudent.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
    ...
    async function populateProgramsTable() {
        ...
        try {
            const res = await fetch('http://localhost/my_midterm/api/Programs/getPrograms.php');
            const data = await res.json();
            if (data.success) {
                tbody.innerHTML = '';
                data.data.forEach(p => {
    ...
    async function renderProgramForm(editData) {
        ...
        try {
            institutesRes = await fetch('http://localhost/my_midterm/api/getInstitutes.php');
        ...
        document.getElementById('program-form').onsubmit = async e => {
            ...
            try {
                let url = 'http://localhost/my_midterm/api/Programs/addProgram.php';
                let body = {program_id, program_name, ins_id};
                if (editData) {
                    url = 'http://localhost/my_midterm/api/Programs/updateProgram.php';
    ...
    async function deleteProgram(id) {
        ...
        try {
            const res = await fetch('http://localhost/my_midterm/api/Programs/deleteProgram.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
            ...
            if (data.success) {
                ...
                // Show if the message is success 
                const container = document.getElementById('program-form-container');
                container.innerHTML = `<div class="success-message">${data.message}</div>`;
                setTimeout(() => { container.innerHTML = ''; }, 1500);
            } else {
    ...
    async function loadYearsAndSemesters() {
        ...
        try {
            const res = await fetch('http://localhost/my_midterm/api/Years&Semesters/getYears.php');
            const data = await res.json();
            if (data.success) {
        ...
        try {
            const res = await fetch('http://localhost/my_midterm/api/Years&Semesters/getSemesters.php');
            const data = await res.json();
            if (data.success) {
    ...
    async function renderYearForm(editData) {
        ...
        document.getElementById('year-form').onsubmit = async e => {
            ...
            try {
                let url = 'http://localhost/my_midterm/api/Years&Semesters/addYear.php';
                let body = {year_id, year_from, year_to};
                if (editData) {
                    url = 'http://localhost/my_midterm/api/Years&Semesters/updateYear.php';
    ...
    async function deleteYear(id) {
        ...
        try {
            const res = await fetch('http://localhost/my_midterm/api/Years&Semesters/deleteYear.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
    ...
    async function renderSemesterForm(editData) {
        ...
        try {
            yearsRes = await fetch('http://localhost/my_midterm/api/Years&Semesters/getYears.php');
        ...
        document.getElementById('semester-form').onsubmit = async e => {
            ...
            try {
                let url = 'http://localhost/my_midterm/api/Years&Semesters/addSemester.php';
                let body = {sem_id, sem_name, year_id};
                if (editData) {
                    url = 'http://localhost/my_midterm/api/Years&Semesters/updateSemester.php';
    ...
    async function deleteSemester(id) {
        ...
        try {
            const res = await fetch('http://localhost/my_midterm/api/Years&Semesters/deleteSemester.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
    ...
    async function loadSubjects() {
        ...
        try {
            const res = await fetch('http://localhost/my_midterm/api/Subjects/getSubjects.php');
            const data = await res.json();
            if (data.success) {
                tbody.innerHTML = '';
                for (const s of data.data) {
    ...
    async function renderSubjectForm(editData) {
        ...
        try {
            semestersRes = await fetch('http://localhost/my_midterm/api/Years&Semesters/getSemesters.php');
        ...
        document.getElementById('subject-form').onsubmit = async e => {
            ...
            try {
                let url = 'http://localhost/my_midterm/api/Subjects/addSubject.php';
                let body = {subject_id, subject_name, sem_id};
                if (editData) {
                    url = 'http://localhost/my_midterm/api/Subjects/updateSubject.php';
    ...
    async function deleteSubject(id) {
        ...
        try {
            const res = await fetch('http://localhost/my_midterm/api/Subjects/deleteSubject.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
    ...
    async function loadEnrollments() {
        ...
        try {
            const res = await fetch('http://localhost/my_midterm/api/Enrollments/getEnrollments.php');
            const data = await res.json();
            if (data.success) {
                tbody.innerHTML = '';
                data.data.forEach(e => {
    ...
    async function renderEnrollmentForm(editData) {
        ...
        try {
            studentsRes = await fetch('http://localhost/my_midterm/api/Students/getStudents.php');
            studentsData = await studentsRes.json();
            subjectsRes = await fetch('http://localhost/my_midterm/api/Subjects/getSubjects.php');
        ...
        document.getElementById('enrollment-form').onsubmit = async e => {
            ...
            try {
                let url = 'http://localhost/my_midterm/api/Enrollments/enrollStudent.php';
                ...
                if (editData) {
                    ...
                    url = 'http://localhost/my_midterm/api/Enrollments/updateEnrollment.php';
    ...
    async function deleteEnrollment(id) {
        ...
        try {
            const res = await fetch('http://localhost/my_midterm/api/Enrollments/removeEnrollment.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
